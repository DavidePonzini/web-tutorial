...
--
-- Table structure for table `daniwebtutorial_products`
--

CREATE TABLE `daniwebtutorial_products` (
...
--
-- Dumping data for table `daniwebtutorial_products`
--

INSERT INTO `daniwebtutorial_products` (`name`, `descr`, `price`, `img_path`) VALUES
...
--
-- Table structure for table `daniwebtutorial_users`
--

CREATE TABLE `daniwebtutorial_users` (
...
--
-- Dumping data for table `daniwebtutorial_users`
--

INSERT INTO `daniwebtutorial_users` (`username`, `email`, `firstname`, `lastname`, `birthdate`, `pwd_hash`, `newsletter`, `admin`) VALUES
...
--
-- Indexes for table `daniwebtutorial_products`
--
ALTER TABLE `daniwebtutorial_products`
  ADD PRIMARY KEY (`name`);

--
-- Indexes for table `daniwebtutorial_users`
--
ALTER TABLE `daniwebtutorial_users`
